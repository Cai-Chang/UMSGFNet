...
def main():
    ...
    print("scaffold")
    smiles_list = pd.read_csv(os.path.join(args.data_dir, args.dataset, 'E:\研究生学习资料\FH-GNN-master\dataset\\lipophilicity\processed\smiles.csv'), header=None)[0].tolist()
